...
// name.splice(2,0,"정약용","김유신","문약점");
// //2번쨰 인덱스에서 0개 삭제하고 3개 데이터추가
// document.write("<br>"+name);
// name.splice(2,2);
// //2번쨰 인덱스에서 2개 삭제
// document.write("<br>"+name);

// //배열의 특정위치의 데이터를 가져오기 - slice
...
//   $("#subject").text(subject[idx]);   //document.getElementById("subject")
// });
...
//       $("#result").html(out);  //document.getElementById("result").innerHTML=
//     }
    
//     $("#subject").text(subject[++idx]);
//     $("#score").val(""); //input태그의 value비우기
//     $("#score").focus(); //input태그에 커서표시
// }
